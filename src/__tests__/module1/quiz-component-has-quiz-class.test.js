    ...
    it('has a Quiz class that extends Component @quiz-component-has-quiz-class',
        () => {
                ...
                if (element.type == 'ClassDeclaration') {
                    if (element.id.name == 'Quiz') {
                        if (element.superClass.name == 'Component') {
                            ...
                            assert(false,
                                "We found a class named Quiz, but it doesn't extend the Component class.")
                        }
                    }
            ...
            assert(class_declaration_count == 1,
                "We found more than one class declaration, but there's only supposed to be one class named Quiz.")
        })
    ...
    it('exports the Quiz class as default @quiz-component-has-quiz-class',
        () => {
            ...
            assert(match != null && match.length > 0,
                "We couldn't find `export default Quiz` at the end of your Quiz.js file.")
        })
})
