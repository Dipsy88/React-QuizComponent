...
describe('QuizQuestion Component', () => {
    it('has li tag with correct value @quiz-question-component-has-correct-li-value',
        () => {
            ...
            assert(div.querySelectorAll('main section ul li').length != 0,
                "We can't find an `li` tag inside of the `ul` tag in the QuizQuestion component's JSX.")
