    ...
    it('has an anchor tag with an onClick handler @quiz-end-component-anchor-has-onclick-handler',
        () => {
            ...
            try {
                ...
                assert(false,
                    "There's not a method named `handleResetClick()` that's being called on anchor click in the QuizEnd class.")
            }
            ...
            assert(spy.calledOnce,
                "There's not a method named `handleResetClick()` that's being called on the anchor click in the QuizEnd class.")
